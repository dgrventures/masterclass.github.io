...
run, you work as exactly one track (see [`/CLAUDE.md`](../../CLAUDE.md) §4).
...
|---|---|---|---|---|
| `MA` | Master / manager | `CLAUDE.md`, `dev/runs/`, `dev/tracks/`, `dev/planning/`, `dev/shared/` (cross-cutting), integration & merges | `main` | No — only for repo-wide ops |
...
- `DS` becomes real once the casepage refactor extracts shared style into
  `dev/shared/style/` (see [`../planning/architecture.md`](../planning/architecture.md)).
