...
in [`../projects/masterclass_fin/`](../projects/masterclass_fin/) so they can be lifted into other projects.
...
Project-specific counterparts live under `../projects/masterclass_fin/` (brief, context, backlog →
