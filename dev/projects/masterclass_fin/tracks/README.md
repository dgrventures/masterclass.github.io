...
|---|---|---|---|---|
| `MA` | Master / manager | `CLAUDE.md`, `dev/projects/masterclass_fin/runs/`, `dev/general/`, `dev/projects/masterclass_fin/tracks/`, `dev/projects/masterclass_fin/plan/`, `dev/projects/masterclass_fin/data/`, `projectapps/masterclass_fin/{specs,versions}/` (cross-cutting), integration & merges | `main` | No — only for repo-wide ops |
